        ...
        <div className="tab-section">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                {partidos.map((p) => {
                    ...
                    return (
                        <div key={p.id} className="partido-card" style={{ background: '#ffffff', border: `1px solid ${c.border}55`, boxShadow: '0 1px 3px rgba(0,0,0,0.06)' }}>
                            <div className="partido-card__row">
                                <span style={{ fontSize: 10, color: '#64748b', fontWeight: 600, width: 90, flexShrink: 0 }}>
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', gap: 6, flex: 1, minWidth: 100 }}>
                                    ...
                                    <span style={{ fontSize: 13, fontWeight: 600, color: '#0f172a' }}>{loc.nombre}</span>
                                </div>
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', gap: 6, flex: 1, minWidth: 100, justifyContent: 'flex-end' }}>
                                    <span style={{ fontSize: 13, fontWeight: 600, color: '#0f172a' }}>{vis.nombre}</span>
                            ...
                            <div className="partido-card__fecha" style={{ color: '#94a3b8' }}>{p.fecha} · RF-05 / RF-15</div>
                        </div>
                    )
                })}
            </div>
